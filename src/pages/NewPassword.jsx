      ...
      <div className="mt-20 md:mt-5 shadow-lg px-5 rounded-xl bg-white">
        <form onSubmit={handleSubmit}>
          ...
          <input
            ...
            value="Save"
            disabled={disabled}
            className="bg-indigo-200 disabled:bg-gray-300  disabled:hover:bg-gray-300 w-full md:w-auto p-3 rounded-xl uppercase font-bold mt-5 hover:cursor-pointer hover:bg-indigo-800"
          />
        </form>
